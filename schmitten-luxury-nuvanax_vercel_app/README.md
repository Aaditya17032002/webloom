# JSON-LD Schema Repository for schmitten-luxury-nuvanax.vercel.app

This repository contains JSON-LD schema files and llm.txt for schmitten-luxury-nuvanax.vercel.app.
...
```html
<script src="https://cdn.jsdelivr.net/gh/Aaditya17032002/webloom@main/schema_repo/schmitten-luxury-nuvanax_vercel_app/schema-loader.js"></script>
```
